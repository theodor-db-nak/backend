...
public interface ICacheEntityBase<TEntity, TId>
{
    ...
    Task<IReadOnlyList<TEntity>> GetBySearchAsync(string searchTerm, Func<CancellationToken, Task<IReadOnlyList<TEntity>>> factory, CancellationToken ct);
    void RemoveByProperty(string prop, string val);
